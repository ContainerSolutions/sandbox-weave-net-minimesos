...
WEAVE_DEBUG=1 /script/weaver iface=weave --no-dns --name 82:e6:9e:fc:9d:af --nickname agent0 --http-addr=127.0.0.1:6784 --ipalloc-range=10.32.0.0/12 --ipalloc-init consensus=1 >weaver.log 2>&1 &
